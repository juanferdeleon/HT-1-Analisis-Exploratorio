...
barplot(yValue,names.arg=xValue,xlab="Month",ylab="Revenue",col="blue", main="Revenue chart",border="red")
...
barplot(lpm,main="Lanzamientos por Mes", xlab="Mes",ylab="Lanzamientos")
```
