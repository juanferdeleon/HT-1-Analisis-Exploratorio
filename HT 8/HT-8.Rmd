...
Tomando como referencia la accuracy De cada uno de estos modelos podemos determinar que las redes neuronales realizadas por la librería de Caret fueron las más efectivas con una diferencia de 0.24% con respecto a las formas por la librería NNet. 
...
Por último al probar con otro modelo la variable evaluar fue el Sale price, en este caso se utilizó el precio para poder determinar como sea la producción cambiando el tipo de topología o función de qué decir utilizada. 

En este caso tenemos una función de tipo entero a diferencia de el modelo anterior que se utilizaba con 01 para poder determinar la pertenencia cada grupo. 
